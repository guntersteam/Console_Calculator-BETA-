...
namespace Project
{
    public class Program
    {
        static void Main()
        {
            NumberFormatInfo newnum = new NumberFormatInfo{
            ...
            do
            {
                ...
                num_1 = Convert.ToDouble(Convert.ToDecimal(Console.ReadLine(),newnum));
                Console.WriteLine("And second :)");
                num_2 = Convert.ToDouble(Convert.ToDecimal(Console.ReadLine(),newnum));
